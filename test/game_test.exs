defmodule GameTest do
    ...
    @players_4 [%Team{players: [%Player{name: 'Player 1'}, %Player{name: 'Player 2'}]}, %Team{players: [%Player{name: "PC"}, %Player{name: "PC-2"}]}]
    ...
    test "deal/1 receives a deck (not shuffled, for well cards checking) and a list of 2 players, split the deck in chunks of 3 cards, and gives a chunk to each player. It returns the players with their cards." do
        assert(create_deck(@players_2) |> deal == [%Team{players: [%Player{card_selected: nil, cards: [%Card{name: "1 de Espada", magic: 13}, %Card{name: "2 de Espada", magic: 8}, %Card{name: "3 de Espada", magic: 9}], name: 'Player 1'}], score: 0, score_hand: 0},
        %Team{players: [%Player{card_selected: nil, cards: [%Card{name: "4 de Espada", magic: 0}, %Card{name: "5 de Espada", magic: 1}, %Card{name: "6 de Espada", magic: 2}], name: 'PC'}], score: 0, score_hand: 0}])
    ...
    test "deal/1 receives a deck (not shuffled, for well cards checking) and a list of 4 players, split the deck in chunks of 3 cards, and gives a chunk to each player. It returns the players with their cards." do
        ...
        assert(create_deck(@players_4) |> deal == [%Team{players: [%Player{card_selected: nil, cards: [%Card{name: "1 de Espada", magic: 13}, %Card{name: "2 de Espada", magic: 8}, %Card{name: "3 de Espada", magic: 9}], name: 'Player 1'},
          %Player{card_selected: nil, cards: [%Card{name: "4 de Espada", magic: 0}, %Card{name: "5 de Espada", magic: 1}, %Card{name: "6 de Espada", magic: 2}], name: 'Player 2'}], score: 0, score_hand: 0},
        %Team{players: [%Player{card_selected: nil, cards: [%Card{name: "7 de Espada", magic: 11}, %Card{name: "10 de Espada", magic: 4}, %Card{name: "11 de Espada", magic: 5},], name: "PC"},
          %Player{card_selected: nil, cards: [%Card{name: "12 de Espada", magic: 6}, %Card{name: "1 de Copa", magic: 7}, %Card{name: "2 de Copa", magic: 8}], name: "PC-2"}], score: 0, score_hand: 0}])
